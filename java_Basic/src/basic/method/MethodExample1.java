...
public class MethodExample1 {
	...
	//메서드의 선언! 항상 가로가 붙음 
	static int calcTotal(int x) {  //x의 값이 아래 반복문으로 들어감.(매개변수)
		//코드 재사용 하기 위해, 
		int total = 0;
		for(int i =1; i <=x; i++) {
			total += i;
		}
		return total;// total의 타입과 같이 calcTotal앞에도 같은 데이터 타입을 적어야함
	//리턴되어 아래쪽으로 값을 던져줌
	}
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		int total =  calcTotal(10); //total은 55의 값을 가짐.
		...
		System.out.println("1~100까지의 누적합: " + calcTotal(700));
