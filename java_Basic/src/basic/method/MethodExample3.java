...
//			break; -->사용 안됨..
			return; // 강제종료 시킨다는 의미임, 값을 반환하는 목적이 아님
			//return을 탈출 용도로 사용하는 것은 void밖에 없음 다른 건 안됨
		}
		int result = n1/n2;
	...
	public static void main(String[] args) {
		...
		int[] totalResult = operateTotal(30, add(2,4)); //add(2,4) =6
		//배열은 배열로 받는다.
    ...
    */
	//int r4 =  multi(10, 7); // 리턴하지 않았기에 변수에 담는거 안됨
//	System.out.println(multi(10, 7)); (x)리턴해서 들어올 값이 없음
	multi(add(3,4), add(4,7)); //-> = multi(7, 11)
//	add(multi(4,4), multi(5,6));멀티는 리턴할 값이 없기에 안됨
