...
public class ArrayListExample {
	...
	public static void main(String[] args) {
        ...
        */
		...
		List<String> nick =new ArrayList<>(); //object타입
		//arrayList보다는 List 인터페이스로 선언해야 다형성이 구성됨
...
//		String name = nick[3];(x)
		...
		//size(): 리스트의 크기 반환 |배열에서 length()였음
		...
		int idx=nick.indexOf("어흥이"); //객체 존재안하면 -1반환
		...
		//imEmpty() :리스트가 비어있는 지의 여부 확인
		System.out.println(nick.isEmpty()); //boolean형태
...
//		Collections.reverse(score); //오름차 정렬을 거꾸로!
