...
public class HashMapExample {
	...
	public static void main(String[] args) {
        ...
        */
		...
		//만약 중복key를 사용하여 put을 호출하면 value만 수정
		map.put("멍멍이", "김뽀삐"); //key중복 ->value값 변함
		map.put("어흥이", "홍길동"); //value중복 ->key로 구분
		System.out.println(map);
		...
		if(map.containsKey(name)) {
			...
			System.out.println("그런 별명 가진 학생은 없습니당");
		}
		System.out.println(map.get("야옹이")); //짝인 value값 나옴
