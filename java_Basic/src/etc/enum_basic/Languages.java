...
public enum Languages {
	...
	PYTHON("파이썬"),
	CPP("C++"), 
	JAVASCRIPT("자바스크립트"), //생성자 쪽으로 문자 전달
	C("c"); //세미콜론 붙이기
	...
	//위에 선언한 방식의 상수와 연관문자를 전달해서 name 필드에 값을 초기화.
